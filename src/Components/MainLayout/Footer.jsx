...
const Footer = () => {
  ...
  return (
    <>
      <div
        className=" pb-4 bg-no-repeat bg-center bg-cover relative"
      ...
      >
        ...
        <Container>
          ...
          <div className="grid justify-between grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-12  2xl:grid-cols-4 gap-10 md:gap-14 lg:gap-24 py-12">
            <div className="md:col-span-4 ">
              <ExtraMidTitle
                className="font-secondary text-secondary font-semibold relative z-[10]"
                text="About"
              />
              <MidTitle
                    ...
                    {menuData.map((item, index) => (
                      <NavLink key={index} to={item.link}>
                        <div className="flex pb-0 md:pb-2 gap-1 md:gap-2 items-center group">
                          ...
                          <MidTitle
                            className="text-secondary group-hover:text-theme text-md hover:ml-1 duration-300 transform  "
                            text={item.name}
                          />
                        </div>
                      </NavLink>
                ...
                <div className="md:col-span-1 ">
                  ...
                  <div className="grid gap-4 grid-cols-1 mt-2 md:mt-5">
                    {contactInformationData.map((item, index) => (
                      <div
                        key={index}
                        className="innerCard  flex items-center gap-4 group"
                      >
            ...
            <div className="md:col-span-3">
              ...
              />
              <MidTitle
                className="font-secondary text-secondary mt-2 md:mt-6"
                text="Subscribe for our upcoming latest articles and news resources."
              />
